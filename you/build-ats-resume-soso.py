#!/usr/bin/env python3
"""Build Rich Tillman's ATS-safe resume, tailored for SOSO (Contract Frontend Developer,
hybrid digital-physical / creative-technology installations). Edit data below, then:
   python3 you/build-ats-resume-soso.py
...
open(os.path.join(here,"resume-soso.html"),'w').write("<!DOCTYPE html><html><head><meta charset='utf-8'>"+CSS+"</head><body>"+''.join(P)+"</body></html>")
...
out='/tmp/pdfout/Rich_Tillman_Resume_SOSO.docx'
