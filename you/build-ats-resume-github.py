#!/usr/bin/env python3
"""Build Rich Tillman's ATS-safe resume, tailored for GitHub's Principal Software Engineer
role in Core UX - owning technical direction for GitHub.com's frontend platform
(performance, accessibility, consistency, availability) across many teams.
   python3 you/build-ats-resume-github.py
Outputs /tmp/pdfout/Rich_Tillman_Resume_GitHub.docx and you/resume-github.html.
...
Why tailored: JD wants paved-path patterns/design systems adopted across many teams,
sequenced cross-team migrations without disrupting active product work, and a track record
on performance/accessibility. Redesign Health's design system (50+ components, org-wide
adoption, 30% dev-time reduction) plus its Vite/Cypress-to-Playwright/OpenAPI migration
bundle is close to a literal match for "paved paths" and "sequencing... without disrupting
active product development." Honest note: the platform work led so far has been at a
10-15 engineer, three-team scale, not GitHub's hundreds of engineers - named plainly rather
than implied away.
"""
import zipfile, html, os
def esc(t): return html.escape(t, quote=False)

NAME="RICH TILLMAN"; TITLE="Principal Software Engineer"
CONTACT="Elizabethton, TN | 843-834-0041 | richtillman@pm.me | linkedin.com/in/effinrich | github.com/effinrich | richtillman.xyz"
SUMMARY=("Principal Software Engineer, 15 years, with a career built around exactly this shape of work: platform-level "
 "frontend architecture that many teams adopt, not one-off solutions. At Redesign Health I built a 50+ component "
 "design system that the whole org (10-15 engineers across three teams) adopted as a paved path, cutting dev time "
 "30 percent, and led the tooling migrations underneath it: Vite becoming the default bundler, Cypress moving to "
 "Playwright, and OpenAPI-generated React Query hooks replacing hand-written API code, all sequenced through an "
 "active codebase without stopping product work. That pattern repeats because I built it on purpose across five "
 "companies: a 200-component React/Storybook library at Freebird that let the org retire separate iOS and Android "
 "teams, and founding Nx-monorepo architecture with 30+ shared libraries at PHC Global. Accessibility and performance "
 "are not afterthoughts either: WCAG 2.1 AA and Lighthouse 100 scores across recent projects, and a 40 percent "
 "rendering-overhead reduction on data-heavy components at Redesign Health. Promoted twice to Engineering Director, "
 "so representing platform priorities to leadership and securing the resourcing to deliver is not new either. "
 "Honest note: the platform work I've led has been at a 10-15 engineer, three-team scale, not GitHub's hundreds of "
 "engineers - the underlying pattern (paved paths, sequenced migrations, cross-team alignment) is identical; the "
 "scale is what I'd be stepping up into.")
JOBS=[
...
SKILLS=[
 ...
 ("Design Systems & Paved Paths","Storybook 10+, Chromatic, Chakra UI, shadcn/ui, Tamagui, Ark UI, Radix UI, Tailwind CSS, Styled Components / CSS-in-JS, Figma Code Connect, shared-library architecture adopted org-wide"),
 ("Testing & Accessibility","Playwright, Cypress, Vitest, Jest, React Testing Library, WCAG 2.1 AA, Lighthouse performance/accessibility auditing"),
 ("Frameworks & Libraries","React 19, Next.js, React Router (SSR/loaders/actions), React Native, Expo, TanStack Start, Node.js / NestJS, React Hooks, Concurrent Rendering"),
 ("Build Tools & Migration","Vite, Nx, Turborepo, pnpm workspaces, Module Federation, Oxlint, GitHub Actions CI/CD, EAS Build, cross-team migration sequencing"),
 ...
 ("Cloud & Infrastructure","GCP, Kubernetes, gRPC"),
 ("Agentic AI Development","Model Context Protocol (MCP) - author production MCP servers, not just a consumer; Claude Code and Cursor (including Cursor's background/autonomous agent) in daily production use; AI model evaluation & red-teaming across frontier LLMs"),
...
open(os.path.join(here,"resume-github.html"),'w').write("<!DOCTYPE html><html><head><meta charset='utf-8'>"+CSS+"</head><body>"+''.join(P)+"</body></html>")
...
out='/tmp/pdfout/Rich_Tillman_Resume_GitHub.docx'
