...
## Draft email (RESOLVED — no longer needed)
~~Hi Oskar — following up on the React/TS CoderPad screen you mentioned. I haven't been able to locate a link for it (or it may have expired) — could you send over a fresh one?~~ — moot, Oskar already resent the link unprompted.
